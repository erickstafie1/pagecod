// api/shopify/callback.js - Primeste token dupa OAuth
...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    // Redirecteaza la pagina embedded cu token in URL (encrypted in production)
    // Pentru simplitate, trimitem la dashboard cu shop si token
